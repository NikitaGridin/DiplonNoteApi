...
router.get("/mostListenedAlbumsInCurrentMonth/:part", albumController.mostListenedAlbumsInCurrentMonth)
router.get("/mostListenedAlbumsInCurrentWeek/:part", albumController.mostListenedAlbumsInCurrentWeek)
