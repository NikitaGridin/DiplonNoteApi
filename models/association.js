...
User.belongsToMany(Track, { through: Coauthor, onDelete: "cascade", unique: true});
Track.belongsToMany(User, { through: Coauthor , onDelete: "cascade", unique: true});
...
User.belongsToMany(Track, { through: LibrayTrack, onDelete: "cascade", unique: true});
Track.belongsToMany(User, { through: LibrayTrack, unique: true});

LibrayTrack.belongsTo(Track);
Track.hasMany(LibrayTrack);

User.belongsToMany(Playlist, { through: LibrayPlaylist, onDelete: "cascade", unique: true});
